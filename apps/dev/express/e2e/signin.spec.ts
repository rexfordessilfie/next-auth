...
test("Sign in with Credentials", async ({ browser }) => {
  ...
  await page.screenshot({ path: "playwright-screenshots/enter-credentials.png", fullPage: true })
  ...
  await page.screenshot({ path: "playwright-screenshots/after-submit.png", fullPage: true })
  ...
  await page.screenshot({ path: "playwright-screenshots/get-session.png", fullPage: true })
